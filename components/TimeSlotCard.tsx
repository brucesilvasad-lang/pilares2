...
const TimeSlotCard: React.FC<TimeSlotCardProps> = ({ timeSlot, services, studentTags, onUpdateStudent, onAddStudentSlot, onRemoveStudentSlot, onUpdateTimeSlot }) => {
  ...
  return (
    <div className="bg-brand-white rounded-xl shadow-lg p-4 sm:p-6 flex flex-col space-y-4 transition-shadow hover:shadow-2xl">
      ...
      <div>
        ...
        <select
          ...
          className="w-full bg-gray-50 border border-gray-200 text-brand-darkgray text-sm font-medium rounded-lg focus:ring-primary focus:border-primary block p-2"
        >
          {services.length === 0 && <option disabled>Crie um serviço nas Configurações</option>}
      ...
      <div className="pt-3 border-t border-gray-200">
        <button
          ...
          className="w-full flex items-center justify-center space-x-2 text-sm text-primary-dark hover:bg-primary-light font-medium py-2 px-4 rounded-lg transition-colors"
        >
          <PlusCircleIcon />
